...
?>
<div class="<?php print $classes; ?> embed-responsive embed-responsive-16by9 media-youtube-<?php print $id; ?>">
  <iframe class="media-youtube-player embed-responsive-item" <?php print $api_id_attribute; ?>width="<?php print $width; ?>" height="<?php print $height; ?>" title="<?php print $title; ?>" src="<?php print $url; ?>" frameborder="0" allowfullscreen><?php print $alternative_content; ?></iframe>
</div>
